...
//static function sinon = require('./../../../../node_modules/sinon');
c//onst Datastore = require('./../../../../node_modules/@google-cloud/datastore');
...
class Entity extends TestHelper {
    ...
    getEvent() {
        ...
        const Event = {
            ...
            eventDescription: 'Party on Mill.',
            eventLocation: {"latitude": 33.424564, "longitude": -111.928001 },
